...
<head>
    <title>Cyberwise Users Thread | Build a Safer and Smarter Online Community</title>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <div class="d-inline-block align-middle">
                                                        <div class="d-inline-block">
                                                            ...
                                                            <h6><a href="{{ route('show-thread', ['id' => $thread->thread_id, 'thread_name' => $thread->thread_name]) }}#posts" class="learn-more-link">{{ $thread->title }}</a></h6>
                                                            <p 
                                                ...
                                                <td class="text-right">
                                                    <div class="text-muted small text-center align-self-center">
                                                        ...
                                                        <span class="comment-btn" data-thread-id="{{ $thread->thread_id }}"><a href="{{ route('dashboard') }}"><i class="far fa-trash-can ml-2 text-c-red"></i></a></span>
                                                    </div>
                                                </td>
                                            </tr>
