					...
					<div class="login-wrap p-4 p-md-5">
						...
						<form id="registerForm" class="signin-form" method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
							...
							<div class="form-group mb-3">
								...
								<input style="height: auto;" type="file" name="avatar" class="form-control" accept="image/*">
							</div>
							<div class="form-group">
								<button type="submit" class="form-control btn btn-primary rounded submit px-3">Sign Up</button>
							</div>
						</form>
            <p class="text-center">Already a member? <a data-toggle="tab" href="{{ route('login') }}#user-login">Sign In</a></p>
					</div>
				</div>
			</div>
		</div>
